# -*- encoding: utf-8 -*-
# stub: parallel_tests 3.7.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.metadata = { "bug_tracker_uri" => "https://github.com/grosser/parallel_tests/issues", "documentation_uri" => "https://github.com/grosser/parallel_tests/blob/v3.7.0/Readme.md", "source_code_uri" => "https://github.com/grosser/parallel_tests/tree/v3.7.0", "wiki_uri" => "https://github.com/grosser/parallel_tests/wiki" } if s.respond_to? :metadata=
